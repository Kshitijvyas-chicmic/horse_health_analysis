...
# Work Directory
# =========================
work_dir = './work_dirs/rtmpose_hoof_590_manual_rotation_jan9'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='../data',
        ann_file='annotations/train_590_fixed.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='../data',
        ann_file='annotations/val_590_fixed.json',
        data_prefix=dict(img='images/hq_consolidation_550/'),
        metainfo=dataset_info,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='../data/annotations/val_590_fixed.json',
    score_mode='keypoint'
)
