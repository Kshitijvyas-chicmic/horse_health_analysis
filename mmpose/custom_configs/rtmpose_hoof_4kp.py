...
load_from = '/app/mmpose/work_dirs/rtmpose_hoof_refined_rotation_experiment_v1/epoch_300.pth'
log_level = 'INFO'
log_processor = dict(
...
work_dir = './work_dirs/automation_run'
